...
//        dump($openId);
        ...
        $input->SetNotify_url("http://o2o.yuntuofu.cn/home/wxpay/notify");
...
//        dump($jsApiParameters);
        ...
        $this->assign('website', 'http://' . $_SERVER['SERVER_NAME']);
        $this->display();
...
class JsApiPay
{
    ...
    public function GetOpenidFromMp($code)
    {
        ...
        $ch = curl_init();
        //设置超时
        curl_setopt($ch, CURLOPT_TIMEOUT, 3600);//$this->curl_timeout
...
class WxPayConfig
{
     ...
     * @var string
     */
    const APPID = 'wx25bd150656c68ce0';
    const MCHID = '1313249101';
    const KEY = '2016hulianwang12188yidongdaqushi';
    const APPSECRET = 'c4be265fdd97ff7da421009e8248cdca';
